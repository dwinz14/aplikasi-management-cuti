                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between mb-3">
                                <div>
                                    <p class="text-xs font-medium text-gray-500 dark:text-gray-400">Sisa Cuti</p>
                                    <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ $sisaCuti }}
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">dari total 12 hari</p>
                        </div>

                        <!-- Used Leave Card -->
                        <div
                            class="bg-white dark:bg-slate-800 p-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-blue-500">
                            <div class="flex items-center justify-between mb-3">
                                <div>
                                    <p class="text-xs font-medium text-gray-500 dark:text-gray-400">Digunakan</p>
                                    <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ $cutiDigunakan }}
                                        <span class="text-sm text-gray-500">Hari</span>
                                    </p>
                                </div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">dari total disetujui</p>
                        </div>
                    </div>
                </div>
            @endif
