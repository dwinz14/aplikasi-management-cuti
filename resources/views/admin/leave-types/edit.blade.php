            ...
            <form method="POST" action="{{ route('admin.leave-types.update', $leaveType->id) }}" class="space-y-6">
                ...
                <div>
                    ...
                    <select id="gender" name="gender" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                        ...
                        <option value="L" {{ old('gender', $leaveType->gender) === 'L' ? 'selected' : '' }}>Laki-laki</option>
                        <option value="P" {{ old('gender', $leaveType->gender) === 'P' ? 'selected' : '' }}>Perempuan</option>
                    </select>
                ...
                <div class="flex items-center">
                    <input id="is_active" name="is_active" type="checkbox" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800" {{ old('is_active', $leaveType->is_active) ? 'checked' : '' }}>
