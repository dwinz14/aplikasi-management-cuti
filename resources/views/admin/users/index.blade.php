                ...
                <form method="GET" action="{{ route('admin.users.index') }}"
                    ...
                    <div>
                        ...
                        <select name="role"
                            ...
                            @foreach (['super_admin', 'hrd', 'kadiv', 'kasie', 'staff', 'direksi'] as $roleOption)
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-700/40 transition-colors">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <span
                                        ...
                                        @elseif($user->role === 'kadiv') bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400
