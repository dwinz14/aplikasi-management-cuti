    ...
    @php
        ...
        function renderProfileIcon($name)
        {
            switch ($name) {
                ...
                case 'role':
                    return '<svg class="w-5 h-5 text-primary-600 dark:text-primary-400" fill="currentColor" viewBox="0 0 20 20"> <path fill-rule="evenodd" d="M10 2a1 1 0 01.553.168l5 3.2A1 1 0 0116 6v4c0 4.418-3.582 8-8 8s-8-3.582-8-8V6a1 1 0 01.447-.832l5-3.2A1 1 0 0110 2zm3.707 6.293a1 1 0 00-1.414-1.414L9 10.172 7.707 8.879a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" /> </svg>';
                case 'clock':
                default:
                            ...
                            dark:from-primary-700 dark:to-primary-800 p-6 relative">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-4">
                                        <div class="relative">
                                            <img src="{{ $user->photo_path ?? 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&background=random&color=fff&size=200' }}"
                                                alt="Foto {{ $user->name }}"
